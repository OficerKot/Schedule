    ...
    <div class="report-page">
        ...
        <div class="filters">
            <div class="filter-group">
                <label for="groupSelect"> Группы (выберите несколько)</label>
                <select id="groupSelect" multiple size="5">
                ...
                <small style="color: var(--t-muted); font-size: 0.7rem; margin-top: 4px;">Зажмите Ctrl для выбора нескольких</small>
            </div>
